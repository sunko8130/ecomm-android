...
public class BrandAdapter extends BaseRecyclerAdapter<BrandAdapter.SubCategoryViewHolder, BrandVO> {
    ...
    public class SubCategoryViewHolder extends BaseViewHolder<BrandVO> {
        ...
        public void setData(BrandVO data) {
            brandVO = data;
            tvCateName.setText(data.getBrandName());
        ...
        public void onClick(View v) {
            ((ProductShowActivity) mContext).onBrandItemClick(brandVO);
        }
    }
}
